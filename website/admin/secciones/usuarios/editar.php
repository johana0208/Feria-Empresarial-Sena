...
if($_POST){
    // Recepcionamos los values del formulario
...
<div class="mb-3">
  ...
  <input type="text"
    class="form-control" value="<?php echo $usuario;?>" name="usuario" id="usuario" aria-describedby="helpId" placeholder="Nombre de usuario">
</div>
<div class="mb-3">
