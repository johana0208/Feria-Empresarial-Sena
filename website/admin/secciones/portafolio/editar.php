...
<div class="mb-3">
  ...
  <input type="text"
    ...
    <div class="mb-3">
      ...
      <input type="text"
        class="form-control"value="<?php echo $subtitulo;?>"  name="subtitulo" id="suptitulo" aria-describedby="helpId" placeholder="subtitulo">
    </div>
<div class="mb-3">
...
<div class="mb-3">
  <label for="cliente" class="form-label">Programadores:</label>
  <input type="text"
